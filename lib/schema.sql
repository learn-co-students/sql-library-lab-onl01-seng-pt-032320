...
CREATE TABLE books (id INTEGER PRIMARY KEY, title TEXT, year INTEGER, series_ID TEXT);
CREATE TABLE characters (id INTEGER PRIMARY KEY, name TEXT, motto TEXT, species TEXT, author_id TEXT);
